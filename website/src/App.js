...
function App() {
  ...
  async function postFile(){
    ...
    var courses = await Axios.post("https://ucsc-courses-website-server.vercel.app/api/post-transcript", formData, config).then(response=>{ console.log(response); parsePDF(response.data, updateCreditsFunc);});
